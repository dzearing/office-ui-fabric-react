...
export const anchorProperties: {
    ...
    onCut: number;
    onPaste: number;
    onCompositionEnd: number;
    onCompositionStart: number;
    onCompositionUpdate: number;
    onFocus: number;
    onFocusCapture: number;
    onBlur: number;
    onBlurCapture: number;
    onChange: number;
    onInput: number;
    onSubmit: number;
    onLoad: number;
    onError: number;
    onKeyDown: number;
    onKeyDownCapture: number;
    onKeyPress: number;
    onKeyUp: number;
    onAbort: number;
    onCanPlay: number;
    onCanPlayThrough: number;
    onDurationChange: number;
    onEmptied: number;
    onEncrypted: number;
    onEnded: number;
    onLoadedData: number;
    onLoadedMetadata: number;
    onLoadStart: number;
    onPause: number;
    onPlay: number;
    onPlaying: number;
    ...
    onMouseOver: number;
    onMouseUp: number;
    onMouseUpCapture: number;
    onSelect: number;
    onTouchCancel: number;
    onTouchEnd: number;
    onTouchMove: number;
    onTouchStart: number;
    onScroll: number;
    ...
    onPointerOut: number;
    onPointerOver: number;
    onPointerUp: number;
    onGotPointerCapture: number;
    onLostPointerCapture: number;
    accessKey: number;
    children: number;
    className: number;
...
// @public
export function getNativeProps<T>(props: {}, allowedPropNames: Record<string, number>, excludedPropNames?: string[]): T;
...
export const iframeProperties: {
    ...
    allowPaymentRequest: number;
    allowTransparency: number;
    csp: number;
    height: number;
    importance: number;
