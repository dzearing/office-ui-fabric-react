...
const LinkBasicExampleCode = require('!raw-loader!@fluentui/react/src/components/Link/examples/Link.Basic.Example.tsx') as string;
...
export const LinkPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@fluentui/react/src/components/Link/docs/LinkOverview.md'),
  bestPractices: '',
  dos: require<string>('!raw-loader!@fluentui/react/src/components/Link/docs/LinkDos.md'),
  donts: require<string>('!raw-loader!@fluentui/react/src/components/Link/docs/LinkDonts.md'),
