...
const DatePickerBasicExampleCode = require('!raw-loader!@fluentui/react/src/components/DatePicker/examples/DatePicker.Basic.Example.tsx') as string;
const DatePickerDisabledExampleCode = require('!raw-loader!@fluentui/react/src/components/DatePicker/examples/DatePicker.Disabled.Example.tsx') as string;
const DatePickerWeekNumbersExampleCode = require('!raw-loader!@fluentui/react/src/components/DatePicker/examples/DatePicker.WeekNumbers.Example.tsx') as string;
const DatePickerRequiredExampleCode = require('!raw-loader!@fluentui/react/src/components/DatePicker/examples/DatePicker.Required.Example.tsx') as string;
const DatePickerInputExampleCode = require('!raw-loader!@fluentui/react/src/components/DatePicker/examples/DatePicker.Input.Example.tsx') as string;
const DatePickerFormatExampleCode = require('!raw-loader!@fluentui/react/src/components/DatePicker/examples/DatePicker.Format.Example.tsx') as string;
const DatePickerBoundedExampleCode = require('!raw-loader!@fluentui/react/src/components/DatePicker/examples/DatePicker.Bounded.Example.tsx') as string;
...
export const DatePickerPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@fluentui/react/src/components/DatePicker/docs/DatePickerOverview.md'),
  bestPractices: '',
  dos: require<string>('!raw-loader!@fluentui/react/src/components/DatePicker/docs/DatePickerDos.md'),
  donts: require<string>('!raw-loader!@fluentui/react/src/components/DatePicker/docs/DatePickerDonts.md'),
